...
-- ----------------------------
-- Table structure for `ib_groups_lectures`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ib_interviews`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ib_lectures`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ib_lectures_attendances`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ib_lectures_records`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ib_users_lectures`
-- ----------------------------
